...
import com.kazurayam.ks.reporting.ReportAdaptersLoader;
...
public class KeywordLogger {
	 ...
	 */
	private static final Map<String, ReportAdapter> reportAdapters = ReportAdaptersLoader.load()
	...
	public void logWarning(String message, Map<String, String> attributes) {
		...
		for (Map.Entry<String, ReportAdapter> pair: reportAdapters.entrySet()) {
			...
			ra.getInstance().logWarning(message)
		}
	}
	...
	public void logPassed(String message, Map<String, String> attributes) {
		...
		for (Map.Entry<String, ReportAdapter> pair: reportAdapters.entrySet()) {
			String className = pair.getKey()
			ReportAdapter ra = pair.getValue()
			ra.getInstance().logPassed(message)
		}
	}
	...
	public void logDebug(String message) {
		...
		for (Map.Entry<String, ReportAdapter> pair: reportAdapters.entrySet()) {
			String className = pair.getKey()
			ReportAdapter ra = pair.getValue()
			ra.getInstance().logDebug(message)
		}
	}
