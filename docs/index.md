...
### Adding a report by Extent Reports

Now I want to add another format of test execution report generated by [Extent Reports](https://extentreports.com/). The following is a fake image of what I want to implement:

![TS1 ExtentReports](https://kazurayam.github.io/KS_Fake_KeywordLogger_Integrates_ExtentReports/images/TS1_ExtentReports.png)

My objective:

1.  `WebUI.comment(message)` should be reported in the output compiled by Extent Reports

2.  Stacktraces of Java Exceptions should be reported in the output compiled by Extent Reports

3.  Screenshots captured during the test execution should be reported in the output compiled by Extent Reports
...
- [Include/scripts/groovy/com/kazurayam/ks/reporting/ReportAdapter.groovy](https://github.com/kazurayam/KS_Fake_KeywordLogger_Integrates_ExtentReports/blob/develop/Include/scripts/groovy/com/kazurayam/ks/reporting/ReportAdapter.groovy)

- [Include/scripts/groovy/com/kazurayam/ks/reporting/ReportAdapterExtentImpl.groovy](https://github.com/kazurayam/KS_Fake_KeywordLogger_Integrates_ExtentReports/blob/develop/Include/scripts/groovy/com/kazurayam/ks/reporting/ReportAdapterExtentImpl.groovy)

- [Include/scripts/groovy/com/kazurayam/ks/reporting/ReportAdaptersLoader.groovy](https://github.com/kazurayam/KS_Fake_KeywordLogger_Integrates_ExtentReports/blob/develop/Include/scripts/groovy/com/kazurayam/ks/reporting/ReportAdaptersLoader.groovy)

- [reporting.config.json](https://github.com/kazurayam/KS_Fake_KeywordLogger_Integrates_ExtentReports/blob/develop/reporting.config.json)
